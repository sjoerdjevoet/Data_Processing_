...
the 10 lowest sales prices are obtained for the bar chart
These array with the bottom 10 is passed to the variable BottomData
...
Yas_Schaal.domain([0, d3.max(BottomData, function(d) { return d.price; } ) ]);

//creating animations (tooltip and delay of display chart) based on BottomData
svg.selectAll('.bar')
.data(BottomData)
.enter()
.append('rect')
...
//creating the bar based on BottomData
.attr({
